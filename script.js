...
/*    setInterval(function(){
    ...
    addDesc(h, [
        ...
        "最終更新: 2023/02/28",
        "",
        '作成者 <a href="https://twitter.com/AXZ_official" target="_blank">@AXZ_official</a>',
        'Tokenの取得の方法は、<a href="https://shunshun94.github.io/shared/sample/discordAccountToken" target="_blank">こちら</a>を参照してください。',
        'また、ご不明な点や改善してほしい点がございましたらDiscordサーバーの<a href="https://discord.gg/9vxwRDZaCV" target="_blank">Az-Community</a>までお越しください。',
        "",
